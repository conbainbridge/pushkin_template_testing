  ...
  if (!props.children) {
    return (
      <Container className="p-0 text-center" fluid>
        <Jumbotron style={{ backgroundImage: `url(${headerImage})`, backgroundPosition: 'center center', marginBottom: '0px', borderRadius: '0' }}>
          <h1 className="justify-content-center">
            Who We Are
          </h1>
          <h4 className="justify-content-center">
            We do citizen science to learn how the mind works.<br/>
